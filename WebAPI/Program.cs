...
//singleton içinde data tutmadýðýmýzda
//scoped datalý = transient
...
builder.Services
    ...
    .AddJwtBearer(options =>
    {
        options.TokenValidationParameters = new TokenValidationParameters()
        {
            ...
            IssuerSigningKey = SecurityKeyHelper.CreateSecurityKey(tokenOptions.SecurityKey), // Valid security key deðeri
...
app.UseCors(builder => builder.WithOrigins("http://localhost:64051", "http://localhost:4200").AllowAnyHeader());
